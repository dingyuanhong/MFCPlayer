...
#ifdef _UNICODE
#define A2PString(A) Acsi2WideByte(A)
#define W2PString(A) (A)
#else
#define APString(A) (A)
#define WPString(A) WideByte2Acsi(A)
#endif

#ifdef _UNICODE
#define P2AString(A) WideByte2Acsi(A)
#define P2WString(A) (A)
#else
#define PAString(A) (A)
#define PWString(A) Acsi2WideByte(A)
#endif

#ifdef _UNICODE
#define Utf82PString Utf82Unicode
#else
#define Utf82PString UTF82ASCII
#endif

#ifdef _UNICODE
#define PString2Utf8 Unicode2Utf8
#else
#define PString2Utf8 ASCII2UTF_8
#endif